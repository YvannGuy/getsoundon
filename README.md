...
- Le contrat affiche avant paiement est le contrat standard GetSoundOn. Apres paiement, contrat et facture PDF sont disponibles dans la carte d'offre et dans `/proprietaire/contrat`.
...
```bash
curl -X POST "https://getsoundon.com/api/stripe/process-balance" \
