    ...
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="rounded-lg bg-indigo-50/80 p-4 text-sm text-slate-700">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="rounded-lg border border-red-200 bg-red-50/50 p-4 text-sm text-red-800">
            Cette action est irréversible. Toutes vos annonces et données seront
        ...
        <DialogContent showClose={true}>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              irréversible. Toutes vos annonces, demandes et messages seront
