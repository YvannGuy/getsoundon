    ...
    <div className="relative mx-auto max-w-5xl">
      ...
      >
        {salles.map((salle) => {
          ...
          const priceLabel = pf ? `${pf.value} €${pf.label}` : "Sur demande";
          const capacityLabel = `${salle.capacity} pers.`;
            ...
            >
              <div className="relative aspect-[4/3] w-full shrink-0 bg-slate-100">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <p className="font-semibold text-white drop-shadow-sm">{salle.name}</p>
                  <p className="mt-0.5 text-sm text-white/90">
                    {salle.city} · {capacityLabel}
                  </p>
