  ...
  return (
    <div className="space-y-4 p-6 md:p-8">
      ...
      <p className="font-landing-body max-w-2xl text-sm text-slate-600">
        Centralisez ici le suivi des retraits et livraisons liés à vos locations. Le détail opérationnel reste
        accessible depuis vos réservations et la messagerie.
      </p>
      <Link href="/proprietaire/reservations" className="inline-flex text-sm font-semibold text-gs-orange hover:underline">
